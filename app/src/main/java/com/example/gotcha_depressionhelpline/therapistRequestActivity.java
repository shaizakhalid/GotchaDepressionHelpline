...
public class therapistRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_therapist_request);
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(therapistRequestActivity.this, "Upload in progress", Toast.LENGTH_SHORT).show();
                } else {
                    uploadFile();
//                    SharedPreferences sharedPreferences=getSharedPreferences("Login_Session", Context.MODE_PRIVATE);
...
//                                    String uploadID = mDatabaseRef.push().getKey();
                                    ...
                                    editor.apply();
                                    Intent i=new Intent(therapistRequestActivity.this,pendingTherapistRequestActivity.class);
                            ...
                            Toast.makeText(therapistRequestActivity.this, "Uploaded Successfully", Toast.LENGTH_LONG).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(therapistRequestActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
